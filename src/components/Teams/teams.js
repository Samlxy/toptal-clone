        ...
        <div className='teams'>
                ...
                <div className='teams-category'>
                    <div className='teams-grid'>
                        <div className='teams-item'>
                            <img src={Hire} className='teams-image' alt='hire' />
                        ...
                        <div className='teams-item'>
                            <img src={Three} className='teams-image' alt='top three' />
                        ...
                        <div className='teams-item'>
                            <img src={Future} className='teams-image' alt='future of work' />
                        ...
                        <div className='teams-item'>
                            <img src={Level} className='teams-image' alt='level above' />
            ...
            <span className='teams-top'>
                <div className='teams-div'>
                    <div><img src={Top} className='images-right' alt='developers talent' />
            ...
            <span className='teams-right'>
                <div className='teams-div'>
                    <div><img src={Right} className='images-right' alt='staff'/>
            ...
            <span className='teams-down'>
                <div className='teams-div'>
                    <div><img src={Down} className='images-right' alt='staff' />
